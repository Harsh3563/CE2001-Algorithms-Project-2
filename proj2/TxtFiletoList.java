...
public class TxtFiletoList
{
   ...
   { // Takes in the filename as method argument
       ...
       int k=0;
       for(int i=2; i<arr.length; i++) // for-loop ignores the 1st value of the string array, which is essentially the hashtag ('#') and the total no. of hospitals (since 'arrFinal' only stores the hospitals' node IDs) 
       {       
